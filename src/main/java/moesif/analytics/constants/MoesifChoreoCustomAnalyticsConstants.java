...
public class MoesifChoreoCustomAnalyticsConstants {
    ...
    public static final String API_USER_NAME_KEY = CUSTOM_ANALYTICS_DATA_PREFIX + "userName";
    public static final String API_CONTEXT_KEY = CUSTOM_ANALYTICS_DATA_PREFIX + "apiContext";
